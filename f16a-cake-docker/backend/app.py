...
app.config['MAIL_USERNAME'] = os.environ.get('MAIL_USERNAME', 'hdingo9900@gmail.com')
app.config['MAIL_PASSWORD'] = os.environ.get('MAIL_PASSWORD', '')
app.config['MAIL_DEFAULT_SENDER'] = os.environ.get('MAIL_USERNAME', 'hdingo9900@gmail.com')
...
PDF_URL_BASE = os.environ.get('PDF_URL_BASE', '/pdfs')
...
API_URL = os.environ.get('AI_API_URL', 'https://api.siliconflow.cn/v1/chat/completions')
MODEL = os.environ.get('AI_MODEL', 'Qwen/QwQ-32B')
API_KEY = os.environ.get('AI_API_KEY', '')

SECRET_KEY = os.environ.get('SECRET_KEY', 'hdingo_secret_key')
